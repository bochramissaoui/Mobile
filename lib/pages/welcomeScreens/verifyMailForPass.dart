...
import '../../controller/passwordController/VerifyMailForPass_Controller.dart';
import '../../utils/global.colors.dart';

class VerifyEmailForPass extends StatefulWidget {
  const VerifyEmailForPass({super.key});

  @override
  State<VerifyEmailForPass> createState() => _VerifyEmailForPassState();
}

class _VerifyEmailForPassState extends State<VerifyEmailForPass> {

  final _formfield = GlobalKey<FormState>();
  VerifyMailForPassController verifyMailForPassController = Get.put( VerifyMailForPassController());
  ...
  Widget build(BuildContext context) {
    ...
    verifyMailForPassController.email=email;
    return Scaffold(
