...
import '../../../controller/profileController/changePasswordController/ChangePass_Controller.dart';
import '../../../utils/global.colors.dart';

class ChangePassProfile extends StatefulWidget {
  const ChangePassProfile({super.key});
...
class _ChangePassProfileState extends State<ChangePassProfile> {
  ...
  ChangePassProfileController changePassProfileController = Get.put( ChangePassProfileController());
                    ...
                    Padding(
                      ...
                      child:TextFormField(
                        validator: (value) {
                          ...
                          } else if (changePassProfileController.passController.text.length < 8) {
                            return "The minimum length for this field is 8 characters."
                                .tr;
                          }
                        },
                        controller: changePassProfileController.passController,
                        style: GoogleFonts.montserrat(
                            color: GlobalColors.BlueColor,
                        ...
                        validator: (value) {
                          if (value!.isEmpty) {
                            return "Confirm Password is required.".tr;
                              ...
                              changePassProfileController.passController.text) {
                            ...
                            ElevatedButton(
                              onPressed: () => {
                                if (_formfield.currentState!.validate())
                                  {
                                    changePassProfileController.change(),
                                    Get.back()
                                  }
                              },
                              style: ButtonStyle(
